...
public final class class_be extends class_cb {
   ...
   public final void func_void_a(Graphics var1, int var2, int var3) {
      ...
      if (this.field_boolean_c) {
         ...
         UIGeneral.func_void_a(var1, 5, var2 + 155 >> 1, var3 + 5);
      ...
      UIGeneral.func_int_a(var1, var2, var3, class_ce.field_class_z_g.loadByIndex(18), 1);
      var1.setColor(var5);
      if (this.field_class_bs_a.soundVolumeLevel == 0) {
         UIGeneral.func_void_a(var1, var2 + 70, var3, BabbleText.instance.getTextById(3945).toCharArray(), 0);
      } else {
         UIGeneral.func_void_a(var1, var2 + 70, var3, BabbleText.instance.getTextById(3944).toCharArray(), 0);
      }

      int var6 = var3 + 20;
      var1.setColor(var7 == 1 ? 16777215 : var4);
      UIGeneral.func_int_a(var1, var2, var6, class_ce.field_class_z_g.loadByIndex(19), 1);
      var1.setColor(var5);
      char[] var8 = class_ce.field_class_z_g.loadByIndex(60 + this.field_class_bs_a.field_byte_a);
      UIGeneral.func_void_a(var1, var2 + 70, var6, var8, 0);
      var6 += 20;
      var1.setColor(var7 == 2 ? 16777215 : var4);
      UIGeneral.func_int_a(var1, var2, var6, class_ce.field_class_z_g.loadByIndex(20), 1);
      var1.setColor(var5);
      UIGeneral.func_void_a(var1, var2 + 70, var6, (this.field_class_bs_a.field_boolean_c ? BabbleText.instance.getTextById(3942) : BabbleText.instance.getTextById(3943)).toCharArray(), 0);
      var6 += 20;
      var1.setColor(var7 == 3 ? 16777215 : var4);
      UIGeneral.func_int_a(var1, var2, var6, class_ce.field_class_z_g.loadByIndex(21), 1);
      var1.setColor(var5);
      UIGeneral.func_void_a(var1, var2 + 70, var6, (this.field_class_bs_a.field_boolean_d ? BabbleText.instance.getTextById(3944) : BabbleText.instance.getTextById(3945)).toCharArray(), 0);
