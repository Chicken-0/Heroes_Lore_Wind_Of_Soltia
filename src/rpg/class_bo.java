...
public final class class_bo extends class_cb {
   ...
   public final void func_void_a(Graphics var1, int var2, int var3) {
      ...
      UIGeneral.func_int_a(var1, var2 + 6, var3 + 4, this.field_array_char_a, 1);
      ...
      for(int var6 = 0; var6 < this.field_array_class_java_lang_Object_a.length; ++var6) {
         if (this.field_array_class_java_lang_Object_a[var6] != null) {
            UIGeneral.func_int_a(var1, var2 + 6, var3 + 27 + var6 * 18, (char[])((char[])this.field_array_class_java_lang_Object_a[var6]), 1);
         }
      }
      ...
      var1.setColor(16777215);
      UIGeneral.func_int_a(var1, var2 + 6, var3 + 99, this.field_array_char_b, 1);
