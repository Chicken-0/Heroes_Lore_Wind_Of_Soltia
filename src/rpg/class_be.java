...
public final class class_be extends class_cb {
   ...
   public final void func_void_a(Graphics var1, int var2, int var3) {
      ...
      var1.setColor(var5);
      if (this.field_class_bs_a.field_int_a == 0) {
         class_bh.func_void_a(var1, var2 + 70, var3, class_cj.field_class_cj_a.func_class_java_lang_String_a(3945).toCharArray(), 0);
      } else {
         class_bh.func_void_a(var1, var2 + 70, var3, class_cj.field_class_cj_a.func_class_java_lang_String_a(3944).toCharArray(), 0);
      }
      ...
      var1.setColor(var5);
      class_bh.func_void_a(var1, var2 + 70, var6, (this.field_class_bs_a.field_boolean_c ? class_cj.field_class_cj_a.func_class_java_lang_String_a(3942) : class_cj.field_class_cj_a.func_class_java_lang_String_a(3943)).toCharArray(), 0);
      var6 += 20;
      var1.setColor(var7 == 3 ? 16777215 : var4);
      class_bh.func_int_a(var1, var2, var6, class_ce.field_class_z_g.func_array_char_a(21), 1);
      var1.setColor(var5);
      class_bh.func_void_a(var1, var2 + 70, var6, (this.field_class_bs_a.field_boolean_d ? class_cj.field_class_cj_a.func_class_java_lang_String_a(3944) : class_cj.field_class_cj_a.func_class_java_lang_String_a(3945)).toCharArray(), 0);
