...
extends cb {
    ...
    public final void a(Graphics graphics, int n2, int n3) {
        ...
        graphics.setColor(0);
        bh.a(graphics, (n2 += 10) + 11, (n3 += 5) + 34, 133, 1, ce.var_z_a.a(15 + this.c - 6));
        graphics.drawImage(ce.var_javax_microedition_lcdui_Image_arr_l[19], n2 + 7, n3 + 80, 20);
        bh.int_a(graphics, n2 + 11, n3 + 84, ce.var_z_a.a(this.c - 6), 1);
        ...
        bh.int_a(graphics, n2 + 9, n3 + 121, ce.var_z_g.a(14), 1);
        if (this.var_byte_b == 1) {
            graphics.setColor(0xFFFFFF);
        } else {
            graphics.setColor(0);
        }
        bh.int_a(graphics, n2 + 37, n3 + 121, ce.var_z_g.a(15), 1);
