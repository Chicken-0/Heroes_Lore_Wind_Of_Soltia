...
// $FF: renamed from: r
public abstract class class_r extends Canvas {
   ...
   public class_r() {
      ...
      field_int_g = this.getWidth();
      field_int_i = field_int_g / 2;
   }
   ...
   public static final void func_void_c(Graphics var0) {
      if (field_int_m >= 3) {
         var0.setColor(0);
         var0.fillRect(0, 0, field_int_g, field_int_h);
         var0.setColor(14663551);
         class_bh.func_int_a(var0, field_int_i - 48, field_int_j - 12, class_bh.field_array_char_p, 0);
         var0.drawLine(field_int_i - 50, field_int_j, field_int_i + 48, field_int_j);
         var0.fillRect(field_int_i - 51, field_int_j + 1, 2, 2);
         var0.fillRect(field_int_i + 48, field_int_j + 1, 2, 2);
         var0.setColor(10452799);
         var0.drawLine(field_int_i - 50, field_int_j + 5, field_int_i + 48, field_int_j + 5);
         var0.fillRect(field_int_i - 51, field_int_j + 3, 2, 2);
         var0.fillRect(field_int_i + 48, field_int_j + 3, 2, 2);
         char[] var1 = class_bh.field_array_char_o;
         class_bh.func_int_a(var0, field_int_i - class_bh.func_int_a(var1) / 2, field_int_j + 50, var1, 0);
      }

      if (field_int_m > 3) {
         var0.setColor(0);
         var0.fillRect(field_int_i + 20, field_int_j - 12, 18, 10);
         var0.setColor(14663551);
         class_bh.func_int_a(var0, field_int_i + 20, field_int_j - 12, "...".substring(0, field_int_m % 4).toCharArray(), 0);
         var0.setColor(14655295);
         var0.fillRect(field_int_i - 48, field_int_j + 2, 95 * (field_int_k < field_int_l ? field_int_k : field_int_l) / field_int_l, 1);
         var0.setColor(16777087);
         var0.fillRect(field_int_i - 48, field_int_j + 3, 95 * (field_int_k < field_int_l ? field_int_k : field_int_l) / field_int_l, 1);
      } else if (field_int_m < 3) {
         var0.setColor(0);
         int var3 = (field_int_h + 11) / 12;

         for(int var2 = 0; var2 < var3; ++var2) {
            var0.fillRect(0, var2 * 12 + field_int_m * 4, field_int_g, 4);
         }
      }
