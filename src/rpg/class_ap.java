...
public final class class_ap extends class_cb {
   ...
   public final boolean func_boolean_a(int var1, int var2) {
      if (this.func_boolean_b(var1, var2)) {
         ...
         if (super.field_byte_b == 0) {
            ...
            super.field_class_cb_b = new class_m(this, var4, super.field_byte_b, class_ax.field_class_z_a.func_array_char_a(3));
         } else if (super.field_byte_b == 1) {
            if ((var4 = var3.field_class_g_a.func_array_byte_a((byte)17)).length > 0) {
               super.field_class_cb_b = new class_m(this, var4, super.field_byte_b, class_ax.field_class_z_a.func_array_char_a(4));
            } else {
               Object[] var5 = new Object[]{class_ax.field_class_z_a.func_array_char_a(5)};
               this.func_void_a(var5);
            }
         } else if (super.field_byte_b == 2) {
            Object[] var6;
            if (this.field_class_t_a == null) {
               var6 = new Object[]{class_ax.field_class_z_a.func_array_char_a(6)};
               this.func_void_a(var6);
            } else if (this.field_class_ad_a == null) {
               var6 = new Object[]{class_ax.field_class_z_a.func_array_char_a(7)};
               this.func_void_a(var6);
            } else if (var3.field_class_g_a.field_int_a < 500) {
               var6 = new Object[]{class_ax.field_class_z_a.func_array_char_a(8)};
               this.func_void_a(var6);
            } else {
               var6 = new Object[]{class_ax.field_class_z_a.func_array_char_a(9)};
   ...
   public final void func_void_a(byte var1, byte var2) {
      ...
      if (var3 instanceof class_af && var1 == 2 && var2 == 0) {
         ...
         super.field_class_cb_b = new class_m(this, var8, (byte)10, class_ax.field_class_z_a.func_array_char_a(10));
         ...
         if (var3 instanceof class_m && (var1 == 0 || var1 == 1)) {
            ...
            if (var1 == 0) {
               ...
               if (!(var5 = (class_t)var4).field_boolean_b) {
                  var6 = new Object[]{class_ax.field_class_z_a.func_array_char_a(11), class_ax.field_class_z_a.func_array_char_a(13)};
                  this.func_void_a(var6);
               } else if (var5.field_byte_c != -1) {
                  var6 = new Object[]{class_ax.field_class_z_a.func_array_char_a(12), class_ax.field_class_z_a.func_array_char_a(13)};
                  this.func_void_a(var6);
               } else {
   ...
   public final void func_void_a(Graphics var1, int var2, int var3) {
      ...
      class_cb.func_void_a(var1, var2 + 4, var3 + 9, this.field_class_t_a, (byte)1, class_ax.field_class_z_a.func_array_char_a(15), super.field_byte_b == 0);
      class_cb.func_void_a(var1, var2 + 4, var3 + 9 + 36, this.field_class_ad_a, (byte)2, class_ax.field_class_z_a.func_array_char_a(16), super.field_byte_b == 1);
      class_cb.func_void_b(var1, var2 + 4, var3 + 9 + 72, 147, 31, 12558207);
      int var4;
      if (this.field_class_t_a != null && this.field_class_ad_a != null) {
         var1.setColor(16777215);
         var4 = (var4 = (var4 = var2 + 6) + 2 + class_bh.func_int_a(var1, var4, var3 + 9 + 72 + 4, class_t.field_class_z_a.func_array_char_a(this.field_class_ad_a.field_byte_g), 1)) + 2 + class_bh.func_int_a(var1, var4, var3 + 9 + 72 + 4, class_ax.field_class_z_a.func_array_char_a(17), 1);
         class_bh.func_int_a(var1, var4, var3 + 9 + 72 + 4, class_ax.field_class_z_a.func_array_char_a(18), 1);
      ...
      class_cb.func_void_a(var1, var2 + (155 - var4 >> 1), var3 + 138, var4, class_ax.field_class_z_a.func_array_char_a(19), super.field_byte_b == 2);
   }
}
