...
public final class class_bn extends class_cb {
      ...
      if (this.func_boolean_b(var1, var2)) {
         ...
         if (var2 != 53 && var1 != 8) {
            ...
            if (super.field_byte_b == 3) {
               var3 = new Object[]{class_ai.field_class_z_a.loadByIndex(59), class_ai.field_class_z_a.loadByIndex(60)};
               ...
               if (!this.field_class_p_a.func_boolean_a(this.field_boolean_c, super.field_byte_b, false)) {
                  var3 = new Object[]{class_ai.field_class_z_a.loadByIndex(62), class_ai.field_class_z_a.loadByIndex(63)};
                  this.func_void_a((byte)1, (byte)0, var3);
               }
            } else {
               var3 = new Object[]{class_ai.field_class_z_a.loadByIndex(61)};
               this.func_void_a((byte)1, (byte)0, var3);
            }
   ...
   public final void func_void_a(Graphics var1, int var2, int var3) {
      ...
      int var6 = MyGameCanvas.func_int_a(var1, class_ai.field_class_z_a.loadByIndex(38), var2 + 6, var5);
      ...
      var6 = MyGameCanvas.func_int_a(var1, class_ai.field_class_z_a.loadByIndex(38), var2 + 51 + 20, var7);
