   ...
   public static final boolean func_boolean_a() {
      ...
      if ((var0 = field_class_ae_a.func_array_byte_a(field_class_ao_a.field_byte_a, field_class_ao_a.field_byte_b)) != null) {
         if (var0[2] == -1) {
            ...
            class_bs.field_class_as_a.func_void_a((UIGeneral.labelTextGain + var1 + UIGeneral.labelTextG).toCharArray(), 16);
         } else if (var0[2] == 22) {
            field_class_ao_a.field_class_g_b.func_boolean_a(class_ad.func_class_ad_a(var0[2], var0[3], true, true), var0[4]);
            char[] var3 = class_h.func_array_char_a(UIGeneral.labelTextGain.toCharArray(), class_ad.field_class_z_b.loadByIndex(var0[2]));
            ...
            char[] var2 = class_h.func_array_char_a(UIGeneral.labelTextGain.toCharArray(), class_ad.field_class_z_b.loadByIndex(var0[2]));
         ...
         if (field_class_ae_a.func_boolean_a(field_class_ao_a.field_byte_a, field_class_ao_a.field_byte_b)) {
            class_bs.field_class_as_a.func_void_a(UIGeneral.labelTextNoSpace, 16);
         }
