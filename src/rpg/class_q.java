...
public final class class_q extends class_cb {
   ...
   public final void func_void_a(Graphics var1, int var2, int var3) {
      ...
      case 0:
         ...
         UIGeneral.func_int_a(var1, var2 + 35, var3 + 18, this.field_array_char_a, 1);
         var1.setColor(14663551);
         UIGeneral.func_int_a(var1, var2 + 33, var3 + 35, this.field_array_char_b, 1);
      ...
      case 1:
         ...
         for(int var7 = 0; var7 < 6; ++var7) {
            UIGeneral.func_int_a(var1, var2 + 38, var3 + 21 + var7 * 15, class_ce.field_class_z_a.loadByIndex(9 + var7), 1);
         }
      ...
      case 2:
         var1.setColor(14663551);
         UIGeneral.func_int_a(var1, var2 + 34, var3 + 18, this.field_array_char_a, 1);
         var1.setColor(16777215);
         char[] var6 = class_ce.field_class_z_a.loadByIndex(class_n.field_byte_a);
         if (MyGameCanvas.canvasWidth > 128) {
            UIGeneral.func_int_a(var1, var2 + 34, var3 + 30, 110, 1, var6);
            return;
         }

         UIGeneral.func_int_a(var1, var2 + 34, var3 + 30, 75, 1, var6);
         return;
      case 3:
         ...
         var1.setColor(16777215);
         UIGeneral.func_int_a(var1, var2 + 40, var3 + 72, class_ai.field_class_z_a.loadByIndex(5), 1);
         var1.setColor(14663551);
         UIGeneral.func_int_a(var1, var2 + 60, var3 + 67, class_ai.field_class_z_a.loadByIndex(6), 1);
         UIGeneral.func_int_a(var1, var2 + 60, var3 + 80, class_ai.field_class_z_a.loadByIndex(7), 1);
      default:
      }
   }
}
