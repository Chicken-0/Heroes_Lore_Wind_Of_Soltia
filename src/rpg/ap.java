...
extends cb {
    ...
    public final boolean a(int n2, int n3) {
        ...
        if (n3 == 53 || n2 == 8) {
            ...
            if (this.var_byte_b == 0) {
                ...
                if (arrby.length > 0) {
                    this.var_cb_b = new m(this, arrby, this.var_byte_b, ax.var_z_a.loadByIndex(4));
                } else {
                    Object[] arrobject = new Object[]{ax.var_z_a.loadByIndex(5)};
                    this.a(arrobject);
                }
            } else if (this.var_byte_b == 2) {
                if (this.var_t_a == null) {
                    Object[] arrobject = new Object[]{ax.var_z_a.loadByIndex(6)};
                    this.a(arrobject);
                } else if (this.var_ad_a == null) {
                    Object[] arrobject = new Object[]{ax.var_z_a.loadByIndex(7)};
                    this.a(arrobject);
                } else if (ao2.var_g_a.var_int_a < 500) {
                    Object[] arrobject = new Object[]{ax.var_z_a.loadByIndex(8)};
                    this.a(arrobject);
                } else {
                    Object[] arrobject = new Object[]{ax.var_z_a.loadByIndex(9)};
    ...
    public final void a(byte by2, byte by3) {
        ...
        if (cb2 instanceof af && by2 == 2 && by3 == 0) {
            ...
            this.var_cb_b = new m(this, arrby, (byte)10, ax.var_z_a.loadByIndex(10));
            this.var_t_a = null;
            this.var_ad_a = null;
            return;
        }
        if (cb2 instanceof m && (by2 == 0 || by2 == 1)) {
            ...
            if (by2 == 0) {
                ...
                if (!t2.b) {
                    ...
                    Object[] arrobject = new Object[]{ax.var_z_a.loadByIndex(12), ax.var_z_a.loadByIndex(13)};
                    this.a(arrobject);
                } else {
                    this.var_t_a = (t)ad2;
                }
    ...
    public final void a(Graphics graphics, int n2, int n3) {
        ...
        cb.a(graphics, n2 + 4, n3 + 9, this.var_t_a, (byte)1, ax.var_z_a.loadByIndex(15), this.var_byte_b == 0);
        cb.a(graphics, n2 + 4, n3 + 9 + 36, this.var_ad_a, (byte)2, ax.var_z_a.loadByIndex(16), this.var_byte_b == 1);
        cb.b(graphics, n2 + 4, n3 + 9 + 72, 147, 31, 12558207);
        if (this.var_t_a != null && this.var_ad_a != null) {
            graphics.setColor(0xFFFFFF);
            n4 = n2 + 6;
            n4 += 2 + bh.int_a(graphics, n4, n3 + 9 + 72 + 4, t.a.loadByIndex(this.var_ad_a.g), 1);
            n4 += 2 + bh.int_a(graphics, n4, n3 + 9 + 72 + 4, ax.var_z_a.loadByIndex(17), 1);
            bh.int_a(graphics, n4, n3 + 9 + 72 + 4, ax.var_z_a.loadByIndex(18), 1);
            cb.a(graphics, n2 + 155 - 10, n3 + 9 + 72 + 5, 500);
            cb.a(graphics, n2 + 155 - 10, n3 + 9 + 72 + 20, n.ao_a().var_g_a.var_int_a);
        }
        n4 = bh.a(155, 80);
        cb.a(graphics, n2 + (155 - n4 >> 1), n3 + 138, n4, ax.var_z_a.loadByIndex(19), this.var_byte_b == 2);
    }
}
